...
namespace Montage.Voip.Rtp
{
    public class RtpPacket
    {
        ...
        private UdpPacket parentPacket;
        ...
        {
            this.DefaultInit();
            this.ParseData(udpPacket.PayloadData);
            this.parentPacket = udpPacket;       
        }        
